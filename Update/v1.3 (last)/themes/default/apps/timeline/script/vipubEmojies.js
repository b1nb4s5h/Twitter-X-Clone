const VipubEmojiSelect = function(options) {
    ...
    let moseMove = false;
    const pickerWidth = this.options.closeButton ? 310 : 150;
        ...
        render: (e, attr) => {
            ...
            const picker = `
                <div class="fg-emoji-container" style="left: ${position.left}px; top: ${position.top}px;">
                    ...
                    <div class="fg-emoji-picker-search" style="display:none">
                        <input type="text" placeholder="Search emoji" autofocus />
